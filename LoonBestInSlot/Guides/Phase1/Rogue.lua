local spec = LBIS:RegisterSpec(LBIS.L["Rogue"], LBIS.L[""], "1")

LBIS:AddItem(spec, "29044", LBIS.L["Head"], "BIS") --Netherblade Facemask
...
LBIS:AddItem(spec, "29045", LBIS.L["Chest"], "BIS") --Netherblade Chestpiece
