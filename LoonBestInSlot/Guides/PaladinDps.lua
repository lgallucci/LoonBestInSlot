...
LBIS:AddItem(spec1, "7419", LBIS.L["Back"], "Alt") --Phalanx Cloak
...
LBIS:AddItem(spec1, "9837", LBIS.L["Wrist"], "Alt") --Banded Bracers
...
LBIS:AddItem(spec1, "209614", LBIS.L["Trinket"], "Alt") --Insignia of the Alliance
