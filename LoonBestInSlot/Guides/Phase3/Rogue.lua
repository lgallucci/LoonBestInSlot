local spec = LBIS:RegisterSpec(LBIS.L["Rogue"], LBIS.L[""], "3")
...
LBIS:AddItem(spec, "30148", LBIS.L["Legs"], "Alt") --Deathmantle Legguards
...
LBIS:AddItem(spec, "24114", LBIS.L["Neck"], "Alt") --Braided Eternium Chain
