local spec = LBIS:RegisterSpec(LBIS.L["Mage"], LBIS.L["Fire"], "2")

LBIS:AddItem(spec, "46129", LBIS.L["Head"], "BIS") --Conqueror's Kirin Tor Hood
...
LBIS:AddItem(spec, "45275", LBIS.L["Wrist"], "BIS") --Bracers of Unleashed Magic
