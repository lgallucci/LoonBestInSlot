local spec = LBIS:RegisterSpec(LBIS.L["Warlock"], LBIS.L["Demonology"], "2")
...
LBIS:AddItem(spec, "45297", LBIS.L["Ring"], "BIS") --Shimmering Seal
...
LBIS:AddItem(spec, "45148", LBIS.L["Trinket"], "BIS") --Living Flame
