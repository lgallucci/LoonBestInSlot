...
local function createTabs(window, content) 
    ...
    local enchantListTabButton = CreateFrame("Button", "ContainerTab2", window, "CharacterFrameTabButtonTemplate")
    ...
    customListTabButton = CreateFrame("Button", "ContainerTab3", window, "CharacterFrameTabButtonTemplate")
...
local function createDropDowns(window)
    ...
    if LBIS.IsSOD then
        ...
        local phase_opts = {
            ...
            ['items']= { LBIS.L["All"], 
            --LBIS.L["PreRaid"], 
            LBIS.L["Phase 1"], LBIS.L["Phase 2"], 
            --LBIS.L["Phase 3"], LBIS.L["Phase 4"], LBIS.L["Phase 5"], LBIS.L["Phase 6"], 
            "BIS" }, 
            --LBIS.L["Phase 7"],
            ['defaultVal']=LBISSettings.SelectedPhase,
            ['changeFunc']=function(dropdown_frame, dropdown_val)
    ...
    if LBIS.IsSOD then
        ...
        local zone_opts = {
            ...
            ['parent']=window,
            ['title']='Zone:',
            ['items']= { LBIS.L["All"], LBIS.L["Blackrock Depths"], LBIS.L["Scholomance"], LBIS.L["Blackrock Spire"], 
                LBIS.L["Stratholme"], LBIS.L["Dire Maul"],
