...
local function createDropDowns(window)
    ...
    local phase_opts = {
        ...
        ['parent']=window,
        ['title']='Phase:',
        ['items']= { LBIS.L["All"], LBIS.L["PreRaid"], LBIS.L["Phase 1"], LBIS.L["Phase 2"], LBIS.L["Phase 3"], "BIS" }, --LBIS.L["Phase 4"], LBIS.L["Phase 5"],
    ...
    local zone_opts = {
        ...
        ['parent']=window,
        ['title']='Raid:',
        ['items']= { LBIS.L["All"], LBIS.L["Naxxramas"], LBIS.L["The Eye of Eternity"], LBIS.L["The Obsidian Sanctum"], LBIS.L["Ulduar"], 
