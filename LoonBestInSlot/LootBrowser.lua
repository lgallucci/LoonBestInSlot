...
function LBIS.BrowserWindow:CreateBrowserWindow()
    ...
    local spec_opts = {
        ...
        ['parent']=window,
        ['title']='Slot:',
        ['items']= { LBIS.L["All"], LBIS.L["Head"], LBIS.L["Shoulders"], LBIS.L["Back"], LBIS.L["Chest"], LBIS.L["Bracers"], LBIS.L["Gloves"], LBIS.L["Belt"], LBIS.L["Legs"], LBIS.L["Feet"], LBIS.L["Neck"], LBIS.L["Ring"], LBIS.L["Trinket"], LBIS.L["Main Hand"], LBIS.L["Off Hand"], LBIS.L["2H"], LBIS.L["Shield"], LBIS.L["Ranged"], LBIS.L["Wand"], LBIS.L["Totem"], LBIS.L["Idol"], LBIS.L["Libram"]},        
