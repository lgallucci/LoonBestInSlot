...
public class ClassSpecGuideMappings
{
    ...
    public ClassSpecGuideMappings()
    {
        ...
        {
            new GuideMapping("#head-for-arms-warrior-dps-phase-1", "Head"),
            new GuideMapping("#shoulders-for-arms-warrior-dps-phase-1", "Shoulder"),
            new GuideMapping("#back-for-arms-warrior-dps-phase-1", "Back"),
            new GuideMapping("#chest-for-arms-warrior-dps-phase-1", "Chest"),
            new GuideMapping("#wrist-for-arms-warrior-dps-phase-1", "Wrist"),
            new GuideMapping("#hands-for-arms-warrior-dps-phase-1", "Hands"),
            new GuideMapping("#waist-for-arms-warrior-dps-phase-1", "Waist"),
            new GuideMapping("#legs-for-arms-warrior-dps-phase-1", "Legs"),
            new GuideMapping("#feet-for-arms-warrior-dps-phase-1", "Feet"),
            new GuideMapping("#neck-for-arms-warrior-dps-phase-1", "Neck"),
