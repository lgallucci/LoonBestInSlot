...
public class ItemSpec
{
    ...
    public List<Tuple<string, string>> Replacements = new List<Tuple<string, string>>
    {
        ...
        new Tuple<string, string>("BIS Until Tier 5", "Alt"),
        new Tuple<string, string>("BIS Until T5", "Alt"),
        new Tuple<string, string>("BIS Until Tier 6", "Alt"),
        new Tuple<string, string>("BIS Until T6", "Alt"),
        ...
        new Tuple<string, string>(" in 9% hit set", ""),
        new Tuple<string, string>(" in 6% hit set", ""),
        new Tuple<string, string>(" in 5% hit set", ""),
        new Tuple<string, string>(" budget option", ""),
        new Tuple<string, string>(" (6% hit set)", ""),
        new Tuple<string, string>(" Balanced Alt", ""),
        new Tuple<string, string>(" Required", ""),
        new Tuple<string, string>(" Drop", ""),
