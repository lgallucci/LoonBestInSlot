...
internal class ClassicMageDpsMapping : ClassicSpecMapping
{
    ...
    public override List<(string, GuideMapping)> Phase5 => new List<(string, GuideMapping)>
        {
            { ("Head", "#head-for-mage-dps-in-phase-5") },
            { ("Shoulder", "#shoulders-for-mage-dps-in-phase-5") },
            { ("Back", "#back-for-mage-dps-in-phase-5") },
            { ("Chest", "#chest-for-mage-dps-in-phase-5") },
            { ("Wrist", "#wrist-for-mage-dps-in-phase-5") },
            { ("Hands", "#hands-for-mage-dps-in-phase-5") },
            { ("Waist", "#waist-for-mage-dps-in-phase-5") },
            { ("Legs", "#legs-for-mage-dps-in-phase-5") },
            { ("Feet", "#feet-for-mage-dps-in-phase-5") },
            { ("Neck", "#neck-for-mage-dps-in-phase-5") },
            { ("Ring", "#rings-for-mage-dps-in-phase-5") },
            { ("Trinket", "#trinkets-for-mage-dps-in-phase-5") },
            { ("Main Hand", "#weapons") },
            { ("Off Hand", "#weapons-2") },
            { ("Ranged/Relic", "#weapons-3") },
        };
