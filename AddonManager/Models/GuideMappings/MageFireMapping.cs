...
internal class MageFireMapping : SpecMapping
{
    ...
    public override List<(string, GuideMapping)> Phase0 => new List<(string, GuideMapping)>
        {
            { ("Main Hand", "#main-hand-weapons-for-fire-mage-dps-phase-2-pre-raid") },
            { ("Two Hand", "#two-handed-weapons-for-fire-mage-dps-phase-2-pre-raid") },
            { ("Off Hand", "#off-hand-weapons-for-fire-mage-dps-phase-2-pre-raid") },
            { ("Ranged/Relic", "#wands-for-fire-mage-dps-phase-2-pre-raid") }
        };
