...
public class PvPImporter : LootImporter
{
    private Dictionary<string, Tuple<string, string>> wowheadUriList = new Dictionary<string, Tuple<string, string>>
    {
        ...
        { @"https://www.wowhead.com/mop-classic/npc=65165/doris-chiltonius#sells;200", new Tuple<string, string>("Malevolent", "Conquest Quartermaster, Kun-Lai Summit") },
        { @"https://www.wowhead.com/mop-classic/npc=65165/doris-chiltonius#sells;250", new Tuple<string, string>("Malevolent", "Conquest Quartermaster, Kun-Lai Summit") },
